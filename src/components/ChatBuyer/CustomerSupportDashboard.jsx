...
import useHover from "../ChatSeller/useHover";
import { TbLayoutSidebarLeftExpand } from "react-icons/tb";

export default function CustomerSupportBuyer() {
      ...
      <div className="layout_container mx-auto mb-2 px-4 sm:px-6 md:px-20 py-2 sm:py-4 md:py-6">
        <div className="flex h-[82vh] gap-[20px]">
          ...
          <div
            className={`${
              showRightSidebar
                ? "block w-[255px] lg:w-[255px] md:w-[200px] sm:w-full"
                : "hidden"
            }`}
          >
            <RightSidebar
